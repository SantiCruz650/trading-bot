...
class StrategyEngine:
    def __init__(self, db: Session):
        ...
        # ETAPA 2B Engines
        from backend.core.ar_dca_engine import ARDCAEngine
        from backend.core.rotation_engine import RotationEngine
        from backend.core.risk_governor import RiskGovernor
        import yaml
